...
class StoreBemMaterialRequest extends FormRequest
{
    /**
    ...
    {
        return $this->user()->can('create', BemMaterial::class);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'codigo_iphan' => ['nullable', 'string', 'unique:bens_materiais,codigo_iphan'],
